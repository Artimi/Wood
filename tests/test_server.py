...
def server(event_loop, unused_tcp_port_factory):
    server = StockServer(public_port=unused_tcp_port_factory(), private_port=unused_tcp_port_factory(), loop=event_loop)
